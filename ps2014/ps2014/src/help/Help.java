...
public class Help extends javax.swing.JFrame {
    ...
    public Help() {
        ...
        setTitle("Ayuda - [Gestor de Terapia]");
        //propiedades de splipanel
        jSplitPane1.setOneTouchExpandable(true);
        jSplitPane1.setDividerLocation(250); //250
        jSplitPane1.setDividerSize(10); //10       
    ...
    {        
        ...
        {            
            ...
            Pattern patron = Pattern.compile("src=\"(\\w+).(jpg|png|PNG|gif)\"");
            Matcher matcher = patron.matcher(value);
            matcher.find();            
    ...
    private void initComponents() {
        ...
        jTree1.setMaximumSize(new java.awt.Dimension(100, 74));

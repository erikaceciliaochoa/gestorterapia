 ...
 * @author usuario
 */
public class iFraMotivo extends modalInternalFrame {
    private DefaultTableModel model;
    private int num;
    /**
     * Creates new form iFraMotivo
     */
    public iFraMotivo() {
        initComponents();
        arranque();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Administrar Motivos de Consulta");
        ...
        rbtNombre.setText("Nombre Motivo");
        ...
        panelRegistrar.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Registrar nuevo Motivo de consulta", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 18))); // NOI18N
...
//    Font fuente1 = new Font("Segoe UI", Font.ITALIC, 18);
//    th.setFont(fuente1); 
    
//    Font fuente = new Font("Segoe UI", Font.PLAIN, 17);
...
//    txtId.setText(String.valueOf(Motivo.cantidad));
...
public void guardar(){
    if(this.txtNombre.getText().isEmpty()){
        ...
        if(this.btnGuardar.getText().equals("Guardar")){ 
            Motivo m = new Motivo();
            m.setDes(this.txtNombre.getText());
            AbstractDAO.almacenaEntidad(m);
            JOptionPane.showMessageDialog(null, "<html><font size=5Registro guardado.");
            arranque();
        }
        else{          
            int id = getId();          
...
public void obtenerTabla(){
   ...
   this.txtNombre.setText(m.getDes());

 ...
 * @author usuario
 */
public class iFraOcupacion extends modalInternalFrame {
    private int num;
    private DefaultTableModel model;
//    DefaultTableModel model;

    /**
     * Creates new form iFraOcupacion
     */
    public iFraOcupacion() {
        initComponents();
        arranque();
        grupoBotones();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Administrar Ocupaciones/Profesiones");
        ...
        panelRegistrar.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Registrar nueva Ocupación o Profesión", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 18))); // NOI18N
        ...
        panelRegistrarLayout.setHorizontalGroup(
            ...
            .addGroup(panelRegistrarLayout.createSequentialGroup()
                ...
                .addGroup(panelRegistrarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtNombre, javax.swing.GroupLayout.PREFERRED_SIZE, 605, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        panelRegistrarLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {lblIdOcupacion1, lblOcupacion1, txtId, txtNombre});
        ...
        rbtNombre.setText("Nombre de Ocupacion/Profesión");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelBuscarLayout.createSequentialGroup()
                ...
                .addGroup(panelBuscarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(panelBuscarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(txtNombreBuscar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 279, javax.swing.GroupLayout.PREFERRED_SIZE))
...
private void arranque(){
    setTitle("Registrar Nueva Ocupación/Profesión");
...
public void guardar(){
    if(this.txtNombre.getText().isEmpty()){
        ...
        if(this.btnGuardar.getText().equals("Guardar")){ 
            ...
            o.setDes(this.txtNombre.getText());
            AbstractDAO.almacenaEntidad(o);
            JOptionPane.showMessageDialog(this, "<html><font size=5>Registro guardado.");
            arranque();
        }
        else{          
            int id = getId();          
            Ocupacion o = AbstractDAO.getEntidad(id, Ocupacion.class);
            o.setDes(this.txtNombre.getText());
            AbstractDAO.almacenaEntidad(o);
...
public void obtenerTabla(){
   int id = getId();   
   Ocupacion o=AbstractDAO.getEntidad(id, Ocupacion.class);
   this.txtId.setText(String.valueOf(o.getId()));
   this.txtNombre.setText(o.getDes());
...
//    try {
//        //Creamos una lista de los datos de la tabla utilizando "List".
//        List<Ocupacion> lista = AbstractDAO.getListaEntidades(Ocupacion.class);     
//        //Utilizamos el método siguiente para cargar el reporte "TipoReport.jasper"
//        //El "JRLoader.loadObject" es el cargador.
//        JasperReport report  = (JasperReport)JRLoader.loadObject(ClassLoader.getSystemResource("Reportes/OcupacionReporte.jasper")); 
...
//        jviewer.setTitle("Lista de Tipos de Ocupación/Profesión.");
//        //La hacemos visible.
...
//    }
    ...
    private void SNroDecimal(JTextField a){
        a.addKeyListener(new KeyAdapter() {
       @Override public void keyTyped(KeyEvent e) {            
		String text = ((JTextField) e.getSource()).getText();
		...
		if (e.getKeyChar() != '.') {
			...
			Toolkit.getDefaultToolkit().beep();
                ...
                if (text.length() >= 4) {
                    e.setKeyChar((char) KeyEvent.VK_CLEAR);//Limpiar el caracter ingresado
                    JOptionPane.showMessageDialog(null, "<html><font size=5 style=color:red;>Ha excedido el número máximo de caracteres!!! (4)", "Validando Datos",
                            JOptionPane.ERROR_MESSAGE);
                }
        }
        });          
